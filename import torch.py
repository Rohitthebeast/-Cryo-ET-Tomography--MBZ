...
from dataset import CryoETPickleDataset, to_tensor  # Ensure correct case
...
def train_dual_net(model, dataloader, num_epochs=25, learning_rate=0.001):
    ...
    for epoch in range(num_epochs):
        ...
        for batch in tqdm(dataloader):
            ...
            noisy_imgs, target_imgs = noisy_imgs.to(device), target_imgs.to(device)  # Move data to CPU
